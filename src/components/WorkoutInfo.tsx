...
function WorkoutInfo() {
    ...
    return (
        ...
        <p>Det går att så klart att utöka träningspassen med kompletterande övningar om så önskas. Övningar för övriga kroppen kan med fördel vara grundövningar som knäböj, marklyft och skivstångsrodd som då tränas på andra dagar.</p>
        </div>    
  )
}
